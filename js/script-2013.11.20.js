		...
		ajax = $.ajax({
			...
			success: function (json) {
				...
				$.each(j, function (i, n) {
					...
					console.log(n);
					$('#content').find('div h2').append('<a class="a' + n[0] + '" href="#b' + n[0] + '">' + ( i + 1 ) + '</a>');
